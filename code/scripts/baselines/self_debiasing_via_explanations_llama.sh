...
for model_path in "${model_paths[@]}"; do
  ...
  output_filepath=<REPO_ROOT>/results/original.unbiased_messages/${model_short}/${dataset}.original.${model_short}.self_debias_explanations.enhanced.jsonl

  echo "  output file: $output_filepath"

  python -m src.other_methods.self_debiasing_via_explanations \
