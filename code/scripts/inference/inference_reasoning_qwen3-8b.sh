...
#   "<REPO_ROOT>/datasets/winoqueer/processed/val/val.jsonl"
    ...
    "<REPO_ROOT>/results/original.unbiased_messages/qwen3-8b.thinking/bbq.original.qwen3-8b.thinking.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/qwen3-8b.thinking/crowdspairs.original.qwen3-8b.thinking.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/qwen3-8b.thinking/genMO.original.qwen3-8b.thinking.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/qwen3-8b.thinking/stereoset.original.qwen3-8b.thinking.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/qwen3-8b.thinking/winoqueer.original.qwen3-8b.thinking.plain.direct_answer.jsonl"
)
names=(
  "bbq"
  "crowdspairs"
