...
#   "<REPO_ROOT>/datasets/winoqueer/processed/val/val.jsonl"
    ...
    "<REPO_ROOT>/results/original.unbiased_messages/deepseek-r1-llama-70b/bbq.original.deepseek-r1-llama-70b.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/deepseek-r1-llama-70b/crowdspairs.original.deepseek-r1-llama-70b.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/deepseek-r1-llama-70b/genMO.original.deepseek-r1-llama-70b.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/deepseek-r1-llama-70b/stereoset.original.deepseek-r1-llama-70b.plain.direct_answer.jsonl"
    "<REPO_ROOT>/results/original.unbiased_messages/deepseek-r1-llama-70b/winoqueer.original.deepseek-r1-llama-70b.plain.direct_answer.jsonl"
)
names=(
  "bbq"
  "crowdspairs"
  ...
  mkdir -p "$outdir_base"
    ...
    for i in "${!data_paths[@]}"; do
        ...
        for p in "${!injection_phrases[@]}"; do
          ...
          outdir_base="${base_out}/${model_tag}"
          output_path="${outdir_base}/${name}.original.${model_tag}.${mode}.${phrase_num}.jsonl"
          ...
          python -m src.inference.inference_reasoning_llms \
