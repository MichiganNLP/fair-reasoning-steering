...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="<HF_HOME>/hub/models--zarahall--fairness-reward-model/snapshots/07cead68c7cbd8cced37c4e7493d73e47b433728", help="Path to the local model checkpoint")
  ...
  # Open output file once (overwrite mode)
    ...
    with open(args.file_path, "r") as fin, open(args.output_path, "w") as fout:
        ...
        for idx, line in enumerate(tqdm(fin, total=total_lines, desc="Scoring steps")):
            ...
            question = line["original"]["prompt"]
            answer = line["reasoning"]
